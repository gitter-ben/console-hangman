...
=========''']
    ...
    def print_wrong_guesses():
        print("Failed guesses: ", end="")
        for i in failed_guesses:
            print(i + " ", end="")
        print("")
    ...
    while not over:
        ...
        if (len(user_guess) == 1):
            if (user_guess in word):
                ...
                failed_guesses.append(user_guess) if user_guess not in failed_guesses else failed_guesses
                stage += 1
                if (stage >= last_index):
                    print("You have lost!")
